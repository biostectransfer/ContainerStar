...
'l!t!Settings/FilterCustomers'
    ...
    var saveFunction = function (e, self) {
        ...
        if (model)
            ...
            self.$('.customer-select-message').show();
    },
    ...
    view = BaseView.extend({
		...
		toolbar: function () {
		    ...
		    return [
        		...
        		{ template: function () { return '<span class="customer-select-message k-widget k-tooltip k-tooltip-validation k-invalid-msg"><span class="k-icon k-warning"></span>' + self.resources.noSelectionMessage + '</span>' } }
		    ];
		}
