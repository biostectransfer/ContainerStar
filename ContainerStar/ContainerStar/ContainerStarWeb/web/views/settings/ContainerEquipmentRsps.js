...
'collections/Settings/ContainerEquipmentRsps',
'l!t!Settings/AddContainerEquipmentRsp'
	...
	var view = BaseView.extend({
		...
		gridSelector: '.grid',
		tableName: 'ContainerEquipmentRsps',
		...
		initialize: function() {
			...
			this.defaultFiltering = { field: 'containerId', operator: 'eq', value: this.model.id };
		...
		render: function () {
		    ...
		    self.grid.bind('edit', function (e) {
		        e.model.containerId = self.model.id;
