...
'collections/Settings/ContainerTypeEquipmentRsps',
'l!t!Settings/AddContainerTypeEquipmentRsp'
	...
	var view = BaseView.extend({
		...
		gridSelector: '.grid',
		tableName: 'ContainerTypeEquipmentRsps',
		...
		initialize: function() {
			...
			this.defaultFiltering = { field: 'containerTypeId', operator: 'eq', value: this.model.id };
		...
		render: function () {
		    ...
		    self.grid.bind('edit', function (e) {
		        e.model.containerTypeId = self.model.id;
