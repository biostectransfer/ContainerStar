	...
	var router = Backbone.Router.extend({
		...
		routes: function() {
		    ...
		    var commonRoutes =
            {
                ...
                'Offers': _.partial(BaseRouter.showView, this, 'l!t!Orders/Offers', false, { IsOffer: true }),
                'Offers/create': _.partial(BaseRouter.showViewWithModel, this, 'l!t!Orders/AddOrders', 'models/Orders', { CommunicationPartners: true }),
                'Offers/:id': _.partial(BaseRouter.showViewWithModel, this, 'l!t!Orders/AddOrders', 'models/Orders', { CommunicationPartners: true }),
                'Orders': _.partial(BaseRouter.showView, this, 'l!t!Orders/Orders', false),
