...
CREATE TABLE [dbo].[Orders](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[CustomerId] [int] NOT NULL,
	[CommunicationPartnerId] [int] NOT NULL,
	...
	[RentOrderNumber] [nvarchar](50) NOT NULL,
	[RentFromDate] [datetime2](2) NULL,
	[RentToDate] [datetime2](2) NULL,
	[AutoBill] [bit] NOT NULL,
	[Discount] [float] NULL,
...
ALTER TABLE [dbo].[Orders]  WITH CHECK ADD  CONSTRAINT [FK_ORDER_CUSTOMER_ID] FOREIGN KEY([CustomerId])
REFERENCES [dbo].[Customers] ([ID])
GO

ALTER TABLE [dbo].[Orders]  WITH CHECK ADD  CONSTRAINT [FK_ORDER_COMMUNICATION_PARTNER_ID] FOREIGN KEY([CommunicationPartnerId])
...
CREATE TABLE [dbo].[Positions](
	...
	[IsSellOrder] [bit] NOT NULL default(0),
	[ContainerId] [int] NULL,
	[AdditionalCostId] [int] NULL,
	[Price] [float] NOT NULL,	
	[FromDate] [datetime2](2) NOT NULL,
	[ToDate] [datetime2](2) NOT NULL,
	[CreateDate] [datetime2](2) NOT NULL,
...
ALTER TABLE [dbo].[Positions]  WITH CHECK ADD  CONSTRAINT [FK_POSITION_ORDER_ID] FOREIGN KEY([OrderId])
REFERENCES [dbo].[Orders] ([ID])
GO

ALTER TABLE [dbo].[Positions]  WITH CHECK ADD  CONSTRAINT [FK_POSITION_CONTAINER_ID] FOREIGN KEY([ContainerId])
REFERENCES [dbo].[Containers] ([ID])
GO

ALTER TABLE [dbo].[Positions]  WITH CHECK ADD  CONSTRAINT [FK_POSITION_ADDITIONAL_COST_ID] FOREIGN KEY([AdditionalCostId])
REFERENCES [dbo].[AdditionalCosts] ([ID])
GO